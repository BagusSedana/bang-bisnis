          ...
          {plans.map((p, i) => (
            ...
            >
              ...
              <a
                ...
                className={`w-full flex items-center justify-center gap-2 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 ${
                  p.popular
                    ? 'btn-primary hover:shadow-blue-primary/30'
                    : 'btn-outline hover:shadow-ink-900/20'
                }`}
              >
                <svg className={`w-4 h-4 ${p.popular ? 'text-white' : 'text-green-600'}`} fill="currentColor" viewBox="0 0 24 24">
